...
访问仓库的 Packages 页面：
```
https://github.com/YOUR_USERNAME/TeleFlux/pkgs/container/teleflux
```
...
```bash
# 拉取最新版本
docker pull ghcr.io/YOUR_USERNAME/teleflux:latest

# 拉取指定版本
docker pull ghcr.io/YOUR_USERNAME/teleflux:v1.1.0

# 拉取主分支最新构建
docker pull ghcr.io/YOUR_USERNAME/teleflux:main
```
...
docker run -d \
  ...
  ghcr.io/YOUR_USERNAME/teleflux:latest
```
...
- `ghcr.io/username/teleflux:v1.1.0` - 版本号
